  ...
  return(
    <>
        ...
        <div className="modal-box max-w-2xl relative py-12 px-20">
            <label htmlFor="updateWorkflow" className="btn btn-sm btn-circle bg-red border-transparent absolute right-20 top-12">✕</label>
            <h1 className="text-3xl mb-3 font-semibold text-blue">Flag Confirmation</h1>
            <form>
            {checker?
                (<div className="mb-4">
            ...
            <div className="flex justify-center">
                <label htmlFor="updateWorkflow" onClick={handleUpdate} className="btn btn-md btn-wide bg-cyan border-transparent outline-none rounded-full mt-4" disabled ={!checker} type="button">
                    Confirm 
                </label>
            </div>
            </form>
