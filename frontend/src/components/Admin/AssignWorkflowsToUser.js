        ...
        <>
            ...
            <div className="modal-box max-w-2xl relative py-12 px-20">
                ...
                <div className="mb-4">
                    ...
                    {/* <input className="shadow appearance-none border rounded-full w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="lastname" type="datetime"/> */}
